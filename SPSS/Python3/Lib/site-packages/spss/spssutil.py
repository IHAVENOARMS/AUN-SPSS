...
def extrapath():
    ...
    if os.path.exists(spssxdcfg):
        ...
        try:
            ...
            if(SpssxdVersionType == "cloud" or SpssxdVersionType == "thinClient"):
        ...
        if sys.platform.lower() == "win32":
            try:
                ...
                winAppPath = os.getenv("ALLUSERSPROFILE")
        ...
        if sys.platform.lower() != "darwin":
            ...
            if SpssxdVersionType != 'cloud' and SpssxdVersionType != 'thinClient':
                spssExtension = os.sep.join(filepath.split(os.path.sep)[0:4])
                spssExtension = os.sep.join([spssExtension, "Extensions", "extensions"])
        if os.path.isdir(spssExtension) and spssExtension not in sys.path:
            sys.path.insert(0, spssExtension)
