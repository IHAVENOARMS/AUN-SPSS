...
DATASET DECLARE ejemplo_bootstrap.
...
OMS /SELECT TABLES
    ...
    /DESTINATION FORMAT=SAV OUTFILE='ejemplo_bootstrap'
   /COLUMNS DIMNAMES=['Variables'  'Estadísticos']
   /TAG='reg_coeff'.
